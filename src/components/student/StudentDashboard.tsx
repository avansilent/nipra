...
export default function StudentDashboard() {
  ...
  return (
    <section className="student-mobile-shell relative w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-10 md:py-16">
      ...
      {error && (
        <div className="student-mobile-banner mb-6 rounded-3xl bg-white px-4 py-3 text-sm text-slate-700 shadow-[0_14px_30px_rgba(15,23,42,0.08)] backdrop-blur-xl">
          {error}
        </div>
      )}
      {!ready ? (
        <div className="student-mobile-loading rounded-[2.2rem] bg-white/92 p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl">
          <p className="text-sm text-slate-500">Loading student dashboard...</p>
        </div>
      ) : (
        <>
          <motion.div initial="hidden" animate="visible" transition={{ duration: 0.45 }} variants={sectionVariant} className="student-mobile-hero relative overflow-hidden rounded-[2.3rem] bg-white/94 p-6 md:p-8 lg:p-10 shadow-[0_30px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl">
            ...
            <div className="student-mobile-hero-row flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div>
              ...
              <div className="student-mobile-next min-w-[240px] rounded-3xl bg-white px-5 py-4 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
            ...
            <div className="student-mobile-stat-grid mt-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <motion.div initial="hidden" animate="visible" transition={{ duration: 0.45, delay: 0.07 }} variants={sectionVariant} className="student-mobile-primary-grid mt-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div className={surfaceClass}>
              ...
              <div className="student-mobile-actions mt-4 grid gap-3 text-sm">
          ...
          <motion.div initial="hidden" animate="visible" transition={{ duration: 0.45, delay: 0.1 }} variants={sectionVariant} className="student-mobile-micro-grid mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <motion.div initial="hidden" animate="visible" transition={{ duration: 0.45, delay: 0.14 }} variants={sectionVariant} className="student-mobile-duo-grid mt-8 grid gap-6 md:grid-cols-2">
