    ...
    <div className="w-full bg-slate-50">
      <section className="bg-gray-50 px-6 py-28">
        <div className="mx-auto w-full max-w-6xl space-y-16">
          ...
          >
            <motion.div variants={sectionContainer} className="rounded-[32px] bg-white px-8 py-16 text-center shadow-[0_24px_70px_rgba(15,23,42,0.08)] md:px-12">
              <div className="mx-auto flex max-w-3xl flex-col items-center justify-center space-y-5">
                ...
                <motion.h1 variants={itemReveal} className="max-w-4xl text-4xl font-bold tracking-[-0.05em] text-slate-900 md:text-6xl">
                  {content.heroTitle}
                </motion.h1>
                <motion.p variants={itemReveal} className="max-w-2xl text-lg leading-relaxed text-gray-600">
                  {content.heroSubtitle}
                </motion.p>
                <motion.div variants={itemReveal} className="mt-4 flex flex-wrap items-center justify-center gap-4">
          ...
          >
            <section id="contact" className="bg-gray-50 px-6 py-20">
              <div className="max-w-4xl mx-auto text-center space-y-6">
                <motion.h3 variants={itemReveal} className="text-3xl font-bold text-gray-900">
                  {content.contactHeading}
                </motion.h3>
                <motion.p variants={itemReveal} className="text-gray-600">
                  Book your free demo session with a simple, clear action flow.
                </motion.p>
                <motion.div variants={itemReveal} className="flex justify-center gap-4 mt-6 flex-wrap">
                  <motion.a
                    whileHover={buttonHover}
                    whileTap={tapPress}
                    href={phoneDialUrl}
                    className="bg-blue-600 text-white px-6 py-3 rounded-xl shadow-md hover:scale-105 transition"
                  >
                    Call Now
                  </motion.a>
                  <motion.a
      ...
      <a
        ...
        className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 shadow-md transition hover:-translate-y-1 hover:shadow-lg"
      >
