    ...
    <section className="relative overflow-hidden bg-gray-50 px-6 py-24">
      ...
      <div className="mx-auto max-w-6xl">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[32px] bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(244,247,250,0.95))] p-8 text-center shadow-[0_30px_80px_rgba(15,23,42,0.12)] ring-1 ring-white/80 md:p-12"
        >
          ...
          <motion.div variants={dashboardItems} initial="hidden" whileInView="show" viewport={viewportOnce} className="mx-auto max-w-3xl space-y-5">
            ...
            <motion.h1 variants={itemReveal} className="text-4xl font-bold tracking-[-0.05em] text-gray-900 md:text-5xl">
            ...
            <motion.div variants={itemReveal} className="flex flex-wrap items-center justify-center gap-4 pt-2">
              <motion.div whileHover={buttonHover} whileTap={tapPress} className="inline-flex">
                <Link href="/courses" className="btn rounded-xl px-6 py-3">
                  Go to Courses
                </Link>
              </motion.div>
              <motion.div whileHover={buttonHover} whileTap={tapPress} className="inline-flex">
                <Link href="/student/dashboard" className="rounded-xl bg-white px-6 py-3 text-sm font-semibold text-slate-800 shadow-[0_14px_30px_rgba(15,23,42,0.08)] transition hover:bg-slate-50">
