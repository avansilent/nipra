    ...
    <section className="mobile-public-shell relative overflow-hidden bg-gray-50 px-6 py-24">
      ...
      <div className="mx-auto max-w-6xl">
        <motion.div
          ...
          className="mobile-public-card rounded-[32px] bg-[linear-gradient(145deg,rgba(255,255,255,0.98),rgba(248,250,252,0.95))] p-8 text-center shadow-[0_30px_80px_rgba(15,23,42,0.12)] ring-1 ring-white/80 md:p-12"
        >
          <div className="mx-auto max-w-2xl space-y-4">
            <motion.div initial="hidden" whileInView="show" viewport={viewportOnce} variants={sectionItems}>
              ...
              <motion.h1 variants={itemReveal} className="mobile-public-title text-3xl font-bold text-gray-900 md:text-4xl">Books</motion.h1>
              ...
              <motion.div variants={itemReveal} whileHover={buttonHover} whileTap={tapPress} className="inline-flex">
                <Link href="/courses" className="mobile-public-cta btn rounded-xl px-6 py-3">Explore Courses</Link>
              </motion.div>
            </motion.div>
          </div>
        </motion.div>
